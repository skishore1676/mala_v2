...
def _render_obsidian_card(
    *,
    ...
    lines = [
        ...
        "",
        "If you agree with recording this as a negative result, no comment is needed.",
        "Add a pointy-bracket comment only if you disagree.",
        "",
        "## What Was Tested",
        "",
    ...
    lines.extend(
        [
            ...
            "",
            "Add a pointy-bracket comment here only if you want to override the recommended next lane.",
            "",
            "## Evidence Identity",
            "",
