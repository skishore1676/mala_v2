...
You are working in a research-only backtesting engine. No deployment plumbing and no live execution. Output is local CSVs, with optional Google Sheet publication of Mala-owned evidence after M5.
